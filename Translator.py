...
root.title("Harsh Project-Language Translator")
def Translate():
...
Label(root,text ="Harsh Project", font = 'arial 15 bold', bg ='white smoke' , width = '20').pack(side = 'bottom')
...
button = Button(root,text="Exit",command=exit,bd=5,font=("Arial",10,"bold"),bg='royal blue',activebackground='skyblue')
button.place(x=510,y=250)
